...
#  set term png medium font arial 10
  ...
  set output "./observables/current/png/zoom_${FILE}.png" 
  ...
  set title "System ${FILE}"
    ...
    plot [0:1] "${FILE}" using 1:3 with lines linestyle 2 title "Current" 
...
#    set term pdfcairo font "Arial,6"
    ...
    set output "./observables/current/pdf/zoom_${FILE}_zoom.pdf" 
