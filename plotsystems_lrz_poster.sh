...
#Legend
  ...
  set style line 1 lt rgb "#003600" lw 2 pt 1
...
#------------------------------------------
 ...
 # set title "SysView for ${FILE}"
   ...
   set title ""
    ...
    plot "${FILE}" using 1:4 with lines linestyle 1 title "Unoccupied" , "${FILE}" using 1:5 with lines linestyle 2 title "Occupied", "${FILE}" using 1:6 with lines linestyle 3 title "Switch function f(x)"
